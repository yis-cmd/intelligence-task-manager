...
class BaseRepository:
    ...
    def select(self, table_name:str, filters:dict[str, Any]):
    ...
    def update(self, table_name:str, data:dict[str, Any], filters:dict[str, Any]):
        values = []
    ...
    def count(self, table_name:str, filters:dict[str, Any]):
